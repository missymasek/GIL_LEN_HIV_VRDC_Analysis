...
*MNM - Unique revenue by member by claim, REV_CNTR_TOT_CHRG_AMT should not vary by claim;
...
*MNM - Append needed fields from ALL_Revenue_HIV;
...
*MNM - Append needed fields from memberlist_2020;
...
*MNM - Only keep data for HIV members, separate step for troubleshooting purposes;
